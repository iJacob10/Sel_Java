...
public class test12_cleartrip {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//button[contains(@class, 'flex flex-middle flex-between t-all fs-2 focus:bc-secondary-500 bg-transparent bc-neutral-100 c-pointer pr-2 pl-3 pt-2 ')]")).click();
		...
		System.out.print("Error message: "+driver.findElement(By.className("to-ellipsis o-hidden ws-nowrap fs-3 c-white")).getText());
